...
CREATE TABLE `BerletTipusok` (
	...
	`hanybelepesreervenyes` int(5) NOT NULL,
...
('Kedves Lorand','0756784324','lorik@yahoo.com','NEM',' ','2021-01-15','1930542670020','Horea 14','0245629872',' '),
('Abraham Imola','0746345632','imolaabr@gmail.com','NEM',' ','2021-02-05','2940125670020','Padurii 12','1021347856',' ');
...
DELETE FROM Kliensek WHERE kliens_id = 12;

SELECT * FROM Kliensek where vonalkod = 0245629872;

SELECT * FROM FTermek;

UPDATE BerletTipusok bt, Belepesek b, Kliensek k SET bt.hanybelepesreervenyes = bt.hanybelepesreervenyes-1 WHERE  bt.berlet_id = b.berlet_id and b.kliens_id = k.kliens_id and k.vonalkod='0245629872';

SELECT k.nev, bt.hanybelepesreervenyes FROM BerletTipusok bt, Belepesek b, Kliensek k WHERE bt.berlet_id = b.berlet_id and b.kliens_id = k.kliens_id and k.vonalkod='0245629872';